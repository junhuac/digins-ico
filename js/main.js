    ...
    setTimeout(function(){
        $('#home-wrap').velocity("transition.fadeIn", {
            ...
            setTimeout(function() {
                ...
                $('.top-nav').addClass('animated-middle fadeInDown').removeClass('opacity-0');
                }, 1200);
            }
...
$(document).ready(function(){
    "use strict";
      ...
      $(".navbar-toggler").on("click", function() {
            $(".navbar-toggler i").toggleClass("ion-close-round ion-navicon-round rotateIn");
            setTimeout(function() {
              $(".navbar-toggler i").removeClass("rotateIn");
            }, 620);
          });

        function menubutton() {
          $(".navbar-toggler i").is(".ion-close-round") && ($(".navbar-toggler i").removeClass("ion-close-round").addClass("ion-navicon-round").toggleClass("rotateIn"), setTimeout(function() {
            $(".navbar-toggler i").removeClass("rotateIn");
          }, 620));
        }
    ...
    $('.link-to-right').on( "click", function() {
        ...
        menubutton();
           ...
           $(".global-overlay").addClass("hide-overlay");
             $("#first-inside").addClass("hide-top");
            $("#second-inside").addClass("hide-bottom");
                $("#back-side").addClass("show-side");
             $(".hide-content").addClass("open-hide");
    ...
    $('.to-close').on( "click", function() {
        ...
        $('.command-info-wrap').toggleClass('show-command');
         $('.mCSB_scrollTools').toggleClass('mCSB_scrollTools-left');
                  $('.top-nav').removeClass('prefixed-nav');
    ...
    $('.to-close-on-nav').on( "click", function() {
        ...
        menubutton();
                ...
                $("#home-wrap").removeClass("hide-left");
           $(".global-overlay").removeClass("hide-overlay");
             $("#first-inside").removeClass("hide-top");
            $("#second-inside").removeClass("hide-bottom");
                $("#back-side").removeClass("show-side");
             $(".hide-content").removeClass("open-hide");
